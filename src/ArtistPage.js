  ...
  return (
    <MainPagePortrait>
      ...
      <StyledSection className="close-up-portrait">
        <MainPagePortraitTextContainer>close-up-portrait goes here</MainPagePortraitTextContainer>
      </StyledSection>
      <StyledSection className="les-essentiels">
        <MainPagePortraitTextContainer>gallery goes here</MainPagePortraitTextContainer>

      </StyledSection>

      <StyledSection className="about-the-project">
        <MainPagePortraitTextContainer>  <SectionHeaderText>Le Project</SectionHeaderText><MainDescriptionContainer>
          ...
          lectus nulla at volutpat diam ut venenatis tellus in metus vulputate
          eu scelerisque felis imperdiet proin fermentum leo vel orci porta non
          ...
          nascetur ridiculus mus mauris vita. Ultricies leo integer malesuada
          nunc vel risus commodo viverra maecenas accumsan lacus vel facilisis
          volutpat amet dictum sit amet justo donec enim diam vulputate ut
          pharetra sit amet aliquam id diam maecenas ultricies mi eget mauris
          pharetra et ultrices neque ornare aenean euismod.
        </MainDescriptionContainer></MainPagePortraitTextContainer>
